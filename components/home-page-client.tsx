  ...
  return (
    <>
      ...
      >
        ...
        <nav className="relative z-50 px-4 pt-4 md:px-6">
          <div className="home-nav-shell max-w-5xl mx-auto flex items-center justify-between px-4 py-3 md:px-5">
              ...
              {NAV_ITEMS.map(item => {
                ...
                return (
                  <Link
                    key={item.href}
                    href={item.href}
                    className="home-nav-link inline-flex items-center gap-1.5 rounded-full px-3 py-1.5 transition-all"
                  >
